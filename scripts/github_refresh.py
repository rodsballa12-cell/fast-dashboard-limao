...
def main():
    ...
    try:
        ...
        # Enriquece aplicacao_reserva com a ficha do produto (config).
        # Não há mais meta de acúmulo: a Stone opera como conta de passagem — o caixa
        # é varrido pra reserva, rende alguns dias e sai numa sangria pro banco
        # principal. Medir "% de uma meta de acúmulo" sobre um saldo em trânsito não
        # dizia nada, então o KPI saiu.
        ...
        if stone_data and _res_cfg and stone_data.get("aplicacao_reserva"):
            ...
            ar["rendimento_previsto_30d"] = float(_res_cfg.get("rendimento_previsto_30d") or 0)
