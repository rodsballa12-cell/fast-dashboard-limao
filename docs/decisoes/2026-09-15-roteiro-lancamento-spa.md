# Campanha de lançamento · só WhatsApp
...
**O erro de calendário era o mais caro:** 20/09/2026 é domingo. O maior dia
de balcão antes da abertura é **sábado 19/09**, com ~48 clientes.

---

## A oferta oficial (não invente outra)

**PACOTE RENOVE-SE · 10 sessões por R$ 1.490**
Fechou o pacote, ganha:
- +1 sessão Renove-se
- +2 sessões à sua escolha
- **+1 escova bônus na Fast Escova**

São 13 sessões por R$ 1.490 — **R$ 114 a sessão**, contra R$ 149 avulsa.

### 🔴 Por que a minha proposta anterior tinha que sair

Eu havia proposto 5 sessões por R$ 490, que dá **R$ 98 a sessão**. Isso é
**mais barato que a promoção oficial da franqueadora**. Vender isso ao grupo
VIP não seria um exclusivo — seria furar o próprio lançamento e ensinar a
melhor cliente da casa que o preço anunciado não é o melhor preço.

**O exclusivo do grupo não pode ser preço menor.** Tem que ser acesso e
brinde — que custam pouco e não desvalorizam nada.
...
## Frente 1 · Grupo VIP (67)

### Mensagem 1 · quinta 17/09

> Vocês 67 vão saber antes de todo mundo.
>
> Sexta que vem abre o Fast Spa, no mesmo prédio da sua escova. Massagem
> sem hora marcada, aqui do lado.
>
> Amanhã, 10h, eu conto o que é de vocês.

### Mensagem 2 · sexta 18/09, 10h

> Dia 25, sexta, abre o Fast Spa Limão — no mesmo prédio da sua escova,
> das 8h às 20h, sem hora marcada.
>
> A promoção de inauguração é o **Pacote Renove-se: 10 sessões por
...
### Mensagem 4 · sexta 25/09, manhã

> Abriu. Até as 20h hoje.
>
...
## Frente 2 · Demais clientes (~344)

Uma mensagem individual, a partir de sexta 25/09.

> Oi [Nome], tudo bem?
>
> O Fast Spa abriu no mesmo prédio da Fast Escova Limão — massagem e
> tratamento, sem hora marcada, igual você já conhece.
>
...
A escova bônus é o melhor argumento dessa mensagem: **é a Escova que aparece
no benefício**, então quem já é cliente daqui entende o valor na hora.

### 🔴 O que quebra essa frente em silêncio

**Lista de transmissão do WhatsApp só entrega para quem tem o número da loja
salvo.** Você manda para 344, acha que 344 receberam, e não aparece erro.

Da melhor saída para a pior:
1. **Individual** nas 261 ativas dos últimos 30 dias, em blocos de 2 a 3 dias
2. **Transmissão** só para quem já conversou com a loja
3. **Status do WhatsApp** — complementa, não substitui

**Nunca mande a mesma mensagem para as duas listas.** Se as 67 virem que o
exclusivo delas foi para todo mundo, acabou o exclusivo.

---

## Calendário (datas conferidas)

| Dia | O quê |
|---|---|
| **qui 17/09** | VIP · mensagem 1 · renovar o `META_ACCESS_TOKEN` |
| **sex 18/09 10h** | VIP · mensagem 2 · avisar recepção e profissionais |
| **🔴 sáb 19/09** | **~48 clientes na Escova — o maior dia de balcão antes da abertura** |
| seg 21 a qua 23/09 | balcão · ~31 somados |
| **qui 24/09** | VIP · mensagem 3 |
| **sex 25/09** | **ABRE, 8h às 20h** · VIP mensagem 4 · começa a frente 2 |
| **sáb 26/09** | 9h–12h só o grupo · ~48 na Escova · equipe completa nos dois |
| dom 27 a qui 01/10 | segue a frente 2, em blocos |

---

## Script de balcão

> "[Nome], o Fast Spa abre sexta aqui do lado — mesmo prédio, sem hora
> marcada, igual aqui.
>
> Na inauguração tem o Pacote Renove-se: 10 sessões por R$ 1.490, e quem
...
🔴 O Spa não tem API da Trinks. **Sem a folha de recepção preenchida desde o
dia 1, nada disso tem placar.**
...
| "Cliente da Escova" no cadastro do Spa + folha de recepção | 24/09 |
