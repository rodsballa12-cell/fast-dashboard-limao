...
| Página | Para quê | Link |
|---|---|---|
| **FAST Insights** | O resumo executivo, para a conversa com a franqueadora | https://claude.ai/code/artifact/cd35b2ac-8e6d-4697-a217-4c667227596d |
| **Da Limão para a Rede** | O plano detalhado + o checklist de descoberta, com as respostas salvas | https://claude.ai/code/artifact/7d10e93e-3111-45fe-a2b3-ca7196ac2f88 |
...
do arquivo e rode `python scripts/modelo_negocio.py` para ver o efeito em cadeia —
é assim que se testa "e se o ticket for R$ 250?" sem refazer conta à mão.
